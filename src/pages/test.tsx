        ...
        <div style={innerContainerStyle}>
          ...
          <div style={illustrationsStyle}>
            ...
            >
              ...
              <circle cx="210" cy="195" r="15" fill="#d2a679" stroke="#444" strokeWidth="2" />
              <circle cx="205" cy="168" r="4" fill="#000" />
              <ellipse cx="215" cy="168" rx="2" ry="4" fill="#000" transform="rotate(20 215 168)" />
              <line x1="210" y1="185" x2="210" y2="205" stroke="#444" strokeWidth="2" />
              <line x1="220" y1="185" x2="220" y2="205" stroke="#444" strokeWidth="2" />
              <line x1="200" y1="200" x2="200" y2="215" stroke="#444" strokeWidth="2" />
              <line x1="210" y1="200" x2="210" y2="215" stroke="#444" strokeWidth="2" />
              <circle cx="260" cy="170" r="15" fill="#888" stroke="#444" strokeWidth="2" />
              <polygon points="255,157 250,150 260,155" fill="#444" />
              <polygon points="265,157 270,150 260,155" fill="#444" />
              <circle cx="260" cy="190" r="12" fill="#888" stroke="#444" strokeWidth="2" />
          ...
          <div>
            <input type="text" placeholder="Enter your query" style={inputStyle} />
...
export default OnlineVeterinaryOffice;
